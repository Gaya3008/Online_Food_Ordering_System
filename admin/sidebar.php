      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="addrestaurant.php">Add New Restaurant</a>
            <a class="collapse-item" href="viewrestaurant.php">View Restaurant</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwot" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="addfood.php">Add New Food</a>
            <a class="collapse-item" href="viewfood.php">View Food</a>
          </div>
        </div>
      </li>
