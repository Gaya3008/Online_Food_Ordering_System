 ...
 if (empty($errors)) 
 {
            ...
            if ($didUpload) {
                //echo "The file " . basename($fileName) . " has been uploaded";
				 $n=iud("INSERT INTO `audio`( `category_id`, `title`, `artist`, `image`, `audio`, `lyrics`) VALUES ('$cat','$title','$artist','$image','$fileName','$lyrics')
					  ");
            ...
            foreach ($errors as $error) {
             ...
             <form class="user" method="post" enctype="multipart/form-data">
				...
				<?php
					...
					<div class="form-group">Upload Mp3 Music
                      <input type="file" class="form-control"   accept=".mp3" name="music" >
                    </div>
                    
					<div class="form-group">Song Lyrics
